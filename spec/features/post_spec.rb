...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      other_user = User.create(first_name: 'Non', last_name: 'Authorized', email: "nonauth@test.com",password: "asdfasdf", password_confirmation: "asdfasdf", phone: "555555555")
  ...
  describe 'delete' do
    it 'can be deleted' do
      # logout from the user set in the "let" block,
      # and make a new user and login as that new user
      logout(:user)
